...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.posts.driver' => 'string',
            'filesystems.disks.posts.root' => 'string',
            'filesystems.disks.changelog.driver' => 'string',
            'filesystems.disks.changelog.root' => 'string',
            ...
            'sheets.default_collection' => 'string',
            'sheets.collections.posts.sheet_class' => 'string',
            'sheets.collections.posts.path_parser' => 'string',
            'sheets.collections.posts.content_parser' => 'string',
            'sheets.collections.posts.extension' => 'string',
            'sheets.collections.changelog.sheet_class' => 'string',
            'sheets.collections.changelog.path_parser' => 'string',
            'sheets.collections.changelog.content_parser' => 'string',
            'sheets.collections.changelog.extension' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.posts.driver','filesystems.disks.posts.root','filesystems.disks.changelog.driver',
'filesystems.disks.changelog.root','filesystems.links./var/www/html/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.failure_email_to','queue.default',
...
'session.http_only','session.same_site','session.partitioned','sheets.default_collection','sheets.collections.posts.sheet_class',
'sheets.collections.posts.path_parser','sheets.collections.posts.content_parser','sheets.collections.posts.extension','sheets.collections.changelog.sheet_class','sheets.collections.changelog.path_parser',
'sheets.collections.changelog.content_parser','sheets.collections.changelog.extension','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'view.paths','view.compiled','passkeys.redirect_to_after_login','passkeys.actions.generate_passkey_register_options','passkeys.actions.store_passkey',
'passkeys.actions.generate_passkey_authentication_options','passkeys.actions.find_passkey','passkeys.relying_party.name','passkeys.relying_party.id','passkeys.relying_party.icon',
'passkeys.models.passkey','passkeys.models.authenticatable','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout','sitemap.guzzle_options.timeout',
...
'web','api',);
        registerArgumentsSet('routes', 'home','about','privacy','terms',
'faq','blog.index','blog.show','changelog.show','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
'password.update','sleep-preferences.edit','sleep-preferences.update','appearance','register','login','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','password.setup','password.setup.store','logout',
'auth.google.redirect','auth.google.callback','storage.local',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','passkeys::passkeys.authenticate_using_passkey','passkeys::passkeys.create',
'passkeys::passkeys.delete','passkeys::passkeys.error_something_went_wrong_generating_the_passkey','passkeys::passkeys.invalid','passkeys::passkeys.last_used','passkeys::passkeys.name',
'passkeys::passkeys.name_placeholder','passkeys::passkeys.no_passkeys_registered','passkeys::passkeys.not_used_yet','passkeys::passkeys.passkeys',);
...
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','FAILURE_EMAIL_TO',);
